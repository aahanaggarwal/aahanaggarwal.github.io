...
pub fn plot_equation(
    ...
    eq_id: i8,
    vars_names: Box<[JsValue]>, // List of variable names ["a", "b"]
    vars_values: Box<[f64]>,    // List of values [1.0, -0.5]
) -> PlotResult {
    ...
    while py < h {
        ...
        while px < w {
            ...
            if case != 0 && case != 15 {
                ...
                match case {
                    1 => push_line(&mut result.lines, p_left_x, p_left_y, p_bottom_x, p_bottom_y),
                    2 => push_line(&mut result.lines, p_bottom_x, p_bottom_y, p_right_x, p_right_y),
                    ...
                    13 => push_line(&mut result.lines, p_bottom_x, p_bottom_y, p_right_x, p_right_y),
                    14 => push_line(&mut result.lines, p_left_x, p_left_y, p_bottom_x, p_bottom_y),
                    _ => {}
                }
